...
def main():
    data_root = "Experiment Results/02_USRP/week04/visual2/data"  # Set your data root
    write_root = "Experiment Results/02_USRP/week04/visual2/spectogram" # Set your save file root

...
def main():
    ...
    data_root = "Experiment Results/02_USRP/week04/Visualization File/data"  # Set your data root
    write_root = "Experiment Results/02_USRP/week04/Visualization File/spectogram" # Set your save file root

...
def main():
    ...
    data_root = "Experiment Results/02_USRP/week03/week3/parameter01/IQ_signal"  # Set your data root
    write_root = "Experiment Results/02_USRP/week03/week3/parameter01/spectrogram" # Set your save file root
